...
export const clinicalApi = {
  ...
  getRejectedRequests: () => api.get('/clinical/requests/rejected'),
  acceptRequest: (id: string) => api.patch(`/clinical/appointments/${id}/accept`),
  rejectRequest: (id: string) => api.patch(`/clinical/appointments/${id}/reject`),
  updateStatus: (id: string, status: string) => api.patch(`/clinical/appointments/${id}/status`, { status }),
